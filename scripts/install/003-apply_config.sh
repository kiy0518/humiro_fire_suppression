...
if command -v nmcli > /dev/null 2>&1; then
    ...
    WIFI_CONNECTIONS=$(nmcli -t -f NAME,TYPE connection show | grep ":802-11-wireless" | cut -d: -f1 | grep -v "^netplan-")
